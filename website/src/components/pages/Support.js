  ...
  render() {
    return (
      <Container text style={s.pageBody}>
        ...
        <p>In addition to keeping the lights on, I'd love to add some features if the basic financial needs of the site are already taken care of, but I need to see that people love it before I put more time into this project of mine.  </p>
